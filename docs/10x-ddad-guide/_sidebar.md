...
* **第三部分:高级实践**
  * [第十四章:架构决策记录(ADR)](chapter14-adr.md)
  * [第十五章:迭代优化](chapter15-iterative-optimization.md)
  * [第十六章:性能优化](chapter16-performance-optimization.md)
